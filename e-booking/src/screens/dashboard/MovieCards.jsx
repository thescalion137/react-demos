import {
    CardActions, CardContent, Paper, Rating, Typography, Button, Card, Modal, CardActionArea, CardMedia
} from '@mui/material';
...
const MovieCards = (props) => {
    ...
    return (
        <div >
            ...
            <Card sx={{ maxWidth: 300, marginTop: '50px' }}>
                <CardMedia
                    component="img"
                    style={{ width: '100%', height: '100%' }}
                    image={props.passed.poster_path == null
                        ? notFoundImage
                ...
                <CardContent>
                    ...
                    {props.passed.original_title === props.passed.title ? (
                        ...
                        <div>
                            ...
                            <Typography gutterBottom variant="h6" component="div">
                                {props.passed.title ? props.passed.title : <p>{" "}</p>}
                            </Typography>
                        </div>
                    )}
                    <Typography variant="body2" noWrap color="text.secondary">
                        {props.passed.overview ? props.passed.overview : <p>{" "}</p>}
                    </Typography>
                </CardContent>
                <CardActions>
                    <Link
